    ...
    <div className="flex h-screen bg-[#F4F7FE] font-sans">
      ...
      <div className="w-[280px] bg-white border-r flex flex-col h-full shrink-0">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          ...
          {/* Inactive Items */}
          {[
            { name: "THƯ VIỆN", path: "/tai-lieu", icon: "M4 6h16M4 10h16M4 14h16M4 18h16" },
            { name: "BÀI KIỂM TRA", path: "/bai-kiem-tra", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
            { name: "FLASHCARD", path: "/flashcard", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
            { name: "GPA", path: "/gpa", icon: "M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" },
            { name: "THẢO LUẬN", path: "/thao-luan", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
            { name: "LIÊN KẾT IUH", path: "/lien-ket", icon: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" }
          ].map((item, idx) => (
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <div className="h-20 bg-white border-b flex justify-between items-center px-8 shrink-0 relative z-10 shadow-sm">
          <div className="flex gap-8">
            ...
            <Link to="/thao-luan" className="font-medium text-gray-500 pb-7 pt-7 hover:text-gray-900">Cộng đồng</Link>
          </div>
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 lg:col-span-8 bg-transparent">
                <div className="flex justify-between items-center mb-6 px-1">
                  ...
                  <button className="text-sm font-bold text-[#3B66F5] uppercase tracking-wider hover:underline">XEM TẤT CẢ</button>
                </div>
