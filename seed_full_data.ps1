Write-Host "Ensure services are running..."
docker compose -f docker-compose.dev.yml up -d --build

Write-Host "Creating database tables..."
docker compose -f docker-compose.dev.yml exec -T backend python create_tables.py

Write-Host "Creating test accounts inside backend container..."
docker compose -f docker-compose.dev.yml exec -T backend python create_test_accounts.py

Write-Host "Importing test data into Postgres (this may take a few seconds)..."
...
VALUES (
    ...
    '[
        ...
        {"id": 7, "text": "7. Your teacher is sick and your class will finish early. Write a text to your father.", "options": ["Teacher is sick. Class will finish early. Pick me up at 10 a.m.", "Class finishes at normal time today.", "I will go home by himself.", "Teacher is sick but class still runs full time."], "answer": 0},
...
Write-Host "Seed complete. Test accounts created:"
Write-Host "  - Admin: username=admin  password=admin123"
Write-Host "  - Student: username=student1  password=student123"
Write-Host "  - Lecturer: username=lecturer1  password=lecturer123"
Write-Host "Finished."
