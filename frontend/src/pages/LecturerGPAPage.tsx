  ...
  return (
    <div className="p-8">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        ...
        <h1 className="text-3xl font-black text-gray-900 mb-3">Trang GPA</h1>
        <p className="text-gray-600 font-medium">
          Da vao duoc trang GPA. Ban co the tiep tuc mo rong chuc nang tinh diem va lich su tinh toan tai day.
        </p>
      </div>
    </div>
  );
