...
| 2   | **Anh**          | **Quản lý Tài liệu**                | - Danh sách Tài liệu (Thư viện + Search/Filter)<br>- Tải tài liệu lên<br>- Chi tiết Tài liệu (tab Thông tin + PDF Viewer)<br>- Modal Chia sẻ Tài liệu | - Documents (CRUD, upload file)<br>- Document metadata<br>- Document_Shares (chia sẻ + permission)<br>- File handling <br>- Backend cho tổng quan admin</br> <br>- Backend cho quản lý người dùng cho trang admin</br> | 08/04/2026     |
| 3   | **Nhật**         | **Tương tác & Thảo luận**           | - Chi tiết Tài liệu (tab Đặt câu hỏi, Thảo luận, Highlight)<br>- Thảo luận (Comments + Reply)<br>- Component Highlight trong PDF | - Questions (đặt câu hỏi về tài liệu)<br>- Discussions (comment + reply)<br>- Highlights (lưu theo trang, màu, ghi chú) <br>- Backend Quản lý tài liệu cho trang admin</br> <br>Backend cho trang kiểm duyệt chia sẻ cho trang admin</br> | 08/04/2026     |
| 4   | **Khang**        | **Kiểm tra, Flashcard & GPA**       | - Danh sách Bài kiểm tra<br>- Làm bài kiểm tra<br>- Kết quả bài kiểm tra<br>- Học Flashcard<br>- Modal Tạo Flashcard<br>- Tính GPA cá nhân <br>- Admin cài đặt hệ thống<br> <br> Admin quản lý tài liệu<br> | - Tests + Test_Results<br>- Flashcards (CRUD + chế độ học)<br>- GPA logic (tính điểm hệ 10/4.0 + lịch sử)<br>- Test submission & scoring <br>- Backend cho trang nhật ký hoạt động cho trang admin </br> <br>- Backend cho trang cài đặt hệ thống trang admin</br> | 08/04/2026     |
