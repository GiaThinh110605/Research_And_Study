    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Link to="/register" className="inline-flex items-center justify-center px-6 py-3 font-semibold text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700">
                Đăng ký ngay
              </Link>
              <button onClick={() => setIsModalOpen(true)} className="px-6 py-3 font-semibold text-blue-600 transition-colors bg-white border-2 border-blue-600 rounded-lg hover:bg-blue-50">
                Tìm hiểu thêm
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/tai-lieu" className="text-gray-400 hover:text-white">Thư viện tài liệu</Link></li>
                <li><Link to="/dashboard" className="text-gray-400 hover:text-white">Bộ đề ôn/trắc nghiệm</Link></li>
                <li><Link to="/dashboard" className="text-gray-400 hover:text-white">Tính điểm GPA</Link></li>
                <li><Link to="/dashboard" className="text-gray-400 hover:text-white">Flashcards học tập</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/" className="text-gray-400 hover:text-white">Trang chủ IUH</Link></li>
                <li><Link to="/" className="text-gray-400 hover:text-white">Cổng sinh viên</Link></li>
                <li><Link to="/" className="text-gray-400 hover:text-white">Hệ thống LMS</Link></li>
                <li><Link to="/" className="text-gray-400 hover:text-white">Phòng đào tạo</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/" className="text-gray-400 hover:text-white">Hướng dẫn sử dụng</Link></li>
                <li><Link to="/" className="text-gray-400 hover:text-white">Câu hỏi thường gặp</Link></li>
                <li><Link to="/" className="text-gray-400 hover:text-white">Điều khoản & Bảo mật</Link></li>
              </ul>
            </div>
          </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="relative w-full max-w-2xl overflow-hidden bg-white shadow-2xl rounded-2xl animate-in fade-in zoom-in-95 duration-200">
            {/* Header / Banner */}
            <div className="relative h-48 bg-blue-900 border-b-4 border-blue-500">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-900 to-blue-700" />
              <div className="absolute bottom-0 left-0 p-6">
                <h2 className="text-3xl font-bold text-white drop-shadow-md">
                  Đại học Công nghiệp TP.HCM
                </h2>
                <p className="mt-1 font-medium tracking-wide text-blue-100">(IUH - Industrial University of Ho Chi Minh City)</p>
              </div>
              <button 
                onClick={() => setIsModalOpen(false)}
                className="absolute p-2 transition-colors rounded-full top-4 right-4 text-white/80 bg-black/20 hover:bg-black/40 hover:text-white"
              >
            ...
            <div className="p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Môi trường Giáo dục Vươn tầm Quốc tế</h3>
                  <p className="mt-2 leading-relaxed text-gray-600">
                    IUH là một trong những trường đại học đa ngành, đa nghề lớn nhất tại Việt Nam. Trường không ngừng đổi mới phương pháp giảng dạy, hướng tới việc đào tạo nguồn nhân lực chất lượng cao, đáp ứng nhu cầu khắt khe của doanh nghiệp trong kỷ nguyên cách mạng công nghiệp 4.0.
                  </p>
                </div>
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 transition-all border border-gray-100 bg-gray-50 rounded-xl hover:bg-blue-50 hover:border-blue-200">
                  <div className="mb-1 text-sm font-semibold tracking-wide text-gray-500 uppercase">Quy mô</div>
                  <div className="text-lg font-bold text-gray-900">Hàng chục nghìn sinh viên</div>
                </div>
                <div className="p-4 transition-all border border-gray-100 bg-gray-50 rounded-xl hover:bg-blue-50 hover:border-blue-200">
                  <div className="mb-1 text-sm font-semibold tracking-wide text-gray-500 uppercase">Thành lập</div>
                  <div className="text-lg font-bold text-gray-900">Năm 1956</div>
                </div>
                <div className="p-4 transition-all border border-gray-100 bg-gray-50 rounded-xl hover:bg-blue-50 hover:border-blue-200">
                  <div className="mb-1 text-sm font-semibold tracking-wide text-gray-500 uppercase">Kiểm định</div>
                  <div className="text-lg font-bold text-gray-900">AUN-QA & ABET</div>
                </div>
                <div className="p-4 transition-all border border-gray-100 bg-gray-50 rounded-xl hover:bg-blue-50 hover:border-blue-200">
                  <div className="mb-1 text-sm font-semibold tracking-wide text-gray-500 uppercase">Cơ sở chính</div>
                  <div className="text-lg font-bold text-gray-900">Gò Vấp, TP.HCM</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end px-8 py-4 border-t bg-gray-50">
              <button 
                onClick={() => setIsModalOpen(false)}
                className="px-5 py-2.5 font-medium text-gray-700 transition-colors bg-white border border-gray-300 rounded-lg hover:bg-gray-100"
              >
                Đóng
              </button>
            </div>
